...
class DSPConfiguration(ConfigurationBase):
    """Class implementing DSP configuration"""

    def __init__(self, configuration_path):
        """
        Initializes the DSPConfiguration.
        :param configuration_path: configuration file(s) path.
        :type configuration_path: str.
        """
        super().__init__(configuration_path)
    ...
    @property
    def configuration_file(self):
        return os.path.join(self.configuration_path, "dsp.json")
